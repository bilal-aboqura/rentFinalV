    ...
    <header className="border-b border-slate-900 bg-slate-950/60 sticky top-0 backdrop-blur-md z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6 text-sm font-medium">
          <Link href="/admin/locations" className={getLinkClass('locations')}>
            Locations
          </Link>
          <Link href="/admin/pricing" className={getLinkClass('pricing')}>
            Pricing Management
          </Link>
          <Link href="/admin/drivers" className={getLinkClass('drivers')}>
            Drivers Management
          </Link>
          <Link href="/admin/bookings" className={`${getLinkClass('bookings')} flex items-center gap-1.5`}>
            <span>Bookings</span>
            {pendingCount > 0 && (
          ...
          <Link href="/admin/inquiries" className={`${getLinkClass('inquiries')} flex items-center gap-1.5`}>
            <span>Inquiries</span>
          ...
          <Link href="/admin/content" className={getLinkClass('content')}>
            Content Management
          </Link>
        </nav>
      </div>
