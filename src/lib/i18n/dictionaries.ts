...
export const dictionary: Record<string, Entry> = {
  ...
  'trip.time': { ar: 'الوقت (24 ساعة)', en: 'Time (24h)' },
  ...
  'trip.returnTime': { ar: 'وقت العودة (24 ساعة)', en: 'Return Time (24h)' },
  ...
  'hospitality.title': { ar: 'الضيافة المجانية', en: 'Complimentary Hospitality' },
  'hospitality.subtitle': {
    ar: 'اختر الضيافة المناسبة لكل راكب، وسيتم تجهيزها مجانًا.',
    en: 'Choose the complimentary hospitality items you want prepared for your passengers.',
  },
  'hospitality.free': { ar: 'مجانيًا', en: 'Free of charge' },
  'hospitality.limit': {
    ar: 'يمكن اختيار كمية لكل عنصر حتى عدد الركاب.',
    en: 'Each item quantity can be selected up to the passenger count.',
  },
  'hospitality.none': { ar: 'لا توجد', en: 'None' },
  ...
  'err.passengers': { ar: 'أدخل عدد ركاب صحيح', en: 'Enter a valid passenger count' },
